...
// users & tokens
const users = Storage.get(USERS_KEY, []) as Array<DbUser>;
const tokens = Storage.get(TOKENS_KEY, {}) as { [token: string]: UserId };

// headlines
const headlines = Storage.get(HEADLINES_KEY, mockHeadlines) as Array<Headline>;

// standings
const standings = Storage.get(
  STANDINGS_KEY,
  mockStandings
